...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Desenvolvimento web, e-commerce, portais e sistemas personalizados em Angola. Peça já o seu orçamento gratuito à ByteKwanzas." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "ByteKwanzas — Soluções Digitais que Transformam o Seu Negócio" },
      { property: "og:description", content: "Desenvolvimento web, e-commerce, portais e sistemas personalizados em Angola. Peça já o seu orçamento gratuito à ByteKwanzas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "ByteKwanzas — Soluções Digitais que Transformam o Seu Negócio" },
      { name: "twitter:description", content: "Desenvolvimento web, e-commerce, portais e sistemas personalizados em Angola. Peça já o seu orçamento gratuito à ByteKwanzas." },
