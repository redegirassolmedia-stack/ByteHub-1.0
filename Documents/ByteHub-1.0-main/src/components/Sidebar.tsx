...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems: { id: MainNavSection; label: string; icon: React.ReactNode; isPrimary?: boolean; badge?: string }[] = [
    ...
    { id: 'equipa', label: 'Equipa de Redes', icon: <Users className="w-5 h-5" /> },
    { id: 'definicoes', label: 'Definições', icon: <Settings className="w-5 h-5" /> },
  ];
